...
public abstract class AbstractSpanBuffer implements SpanBuffer {
    ...
    /**
     * Consumes the needleWalker while attempting to match the hayWalker. On success the needleWalker.hasNext() will
     * return false and hayWalker.getPos() will return the position of the match.
     * <p>
     * On failure sets the hayWalker back to starting position.
     * </p>
     *
     * @param hayWalker
     *            haystack where the niddle may be contained
     * @param needleWalker
     *            needle to find
    ...
    private static class WalkerImpl implements SpanBuffer.Walker {
         ...
         *
         * @param sb
         *            the span buffer to walk.
         * @param pos
         *            the absolute position to start at.
         */
