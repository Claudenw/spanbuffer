 ...
 *
 * <p>
 * This is generally used to add functionality to an existing SpanBuffer
 * implementation.
 * </p>
 */
public abstract class WrappedSpanBuffer implements SpanBuffer {
	 ...
	 * Constructor.
	 * <p>
	 * If the <code>sb</code> parameter is a WrappedSpanBuffer instance its inner
	 * buffer is located and wrapped.
	 * </p>
	 *
	 * @param sb The span buffer to wrap
	 */
