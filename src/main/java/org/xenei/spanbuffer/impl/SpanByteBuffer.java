...
/**
 * A span that comprises a ByteBuffer. The logical beginning of the SpanBuffer (offset) may be specified.
 */
public class SpanByteBuffer extends AbstractSpanBuffer {
     ...
     *
     * <p>
     * Construct from a byte buffer. The offset specifies the logical position of the first byte in the buffer.
     * </p>
     *
     * @param offset
     *            the external offset for the buffer.
     * @param buffer
     *            The byte buffer to use.
     */
